...
enum { SchemeDate, SchemeNorm, SchemeSel, SchemeHid, SchemeWarn, SchemeUrgent, SchemeStatus, SchemeTagsSel, SchemeTagsNorm, SchemeInfoSel, SchemeInfoNorm }; /* color schemes */
